...
train_texts, temp_texts, train_labels, temp_labels = train_test_split(preprocessed_texts, encoded_categories, test_size=0.1, random_state=42)
...
model = BertForSequenceClassification.from_pretrained('bert-base-cased', num_labels=len(set(encoded_categories)))
